...
(function () {
  ...
  var CSS = [
    ...
    'background:transparent;border:1px solid var(--inverse-line,rgba(255,255,255,.24));border-radius:var(--c-radius,0);',
    ...
    'border-left:1px solid var(--inverse-line,rgba(255,255,255,.24));border-radius:var(--c-radius,0);',
    ...
    'background:var(--black,#000);color:var(--white,#fff);border:1px solid var(--white,#fff);border-radius:var(--c-radius,0);',
    ...
    '.cpanel-x{margin-left:auto;width:32px;height:32px;border:0;border-radius:var(--c-radius,0);background:none;',
    ...
    '.cadd{height:44px;border:0;border-radius:var(--c-radius,0);background:var(--black,#000);color:var(--white,#fff);',
    ...
    '.cexport{height:44px;padding:0 16px;background:transparent;border:1px solid var(--black,#000);border-radius:var(--c-radius,0);',
    ...
    '.cfbtn{padding:6px 10px;border:0;border-radius:var(--c-radius,0);background:transparent;color:var(--gray-500,#6f6f6f);',
    ...
    '.cfsel{height:30px;max-width:150px;padding:0 8px;border:1px solid var(--gray-300,#e2e2e2);border-radius:var(--c-radius,0);',
    ...
    'width:28px;height:28px;padding:0;background:none;border:0;border-radius:var(--c-radius,0);',
    ...
    'border:1px solid var(--gray-300,#e2e2e2);border-radius:var(--c-radius,0);background:var(--white,#fff);',
    ...
    '.cprim{height:40px;padding:0 18px;border:0;border-radius:var(--c-radius,0);background:var(--black,#000);color:var(--white,#fff);',
    ...
    '.cghost{height:40px;padding:0 18px;background:transparent;border:1px solid var(--black,#000);border-radius:var(--c-radius,0);',
